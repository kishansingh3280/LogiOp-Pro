...
const styles = StyleSheet.create({
  ...
  seg: { flex: 1, paddingVertical: 7, alignItems: "center", borderRadius: radii.pill },
  segActive: { backgroundColor: colors.lime },
  segText: { color: colors.textMuted, fontWeight: "700", fontSize: 12 },
  segTextActive: { color: colors.bg },
  scroll: { paddingHorizontal: spacing.lg, paddingBottom: 120 },
  statsStrip: { flexDirection: "row", gap: spacing.sm, marginBottom: spacing.sm },
  stat: {
    flex: 1,
    padding: 10,
    backgroundColor: colors.surface,
  ...
  statLbl: { color: colors.textDim, fontSize: 9, textTransform: "uppercase", letterSpacing: 0.5 },
  statVal: { fontSize: 16, fontWeight: "800", marginTop: 3 },
  chipRow: { gap: 6, paddingBottom: spacing.sm },
  chip: {
    height: 28, paddingHorizontal: 11, borderRadius: radii.pill,
  ...
  txnNo: { color: colors.text, fontSize: 13, fontWeight: "800", letterSpacing: 0.3 },
  txnKind: { color: colors.textDim, fontSize: 11, marginTop: 1 },
  statusPill: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: radii.pill, borderWidth: 1 },
  statusPillText: { fontSize: 9, fontWeight: "800", letterSpacing: 0.4 },
  txnBody: { gap: 3, marginTop: 6, paddingTop: 6, borderTopColor: colors.border, borderTopWidth: StyleSheet.hairlineWidth },
  row: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 2 },
  rowLbl: { color: colors.textDim, fontSize: 11 },
  rowVal: { color: colors.text, fontSize: 12, fontWeight: "600" },
  txnFoot: {
    flexDirection: "row", alignItems: "center", gap: 4,
    marginTop: 5, paddingTop: 5, borderTopColor: colors.border, borderTopWidth: StyleSheet.hairlineWidth,
  },
  txnFootText: { color: colors.textDim, fontSize: 10, flex: 1 },
  ...
  remainChipText: { color: colors.warn, fontSize: 9, fontWeight: "800", letterSpacing: 0.3 },
  childChip: {
    flexDirection: "row", alignItems: "center", gap: 4,
    paddingHorizontal: 7, paddingVertical: 2, borderRadius: radii.pill,
  ...
  childChipText: { color: colors.info, fontSize: 9, fontWeight: "800", letterSpacing: 0.3 },
  splitBtn: {
    flexDirection: "row", alignItems: "center", gap: 4,
  ...
  splitBtnText: { color: colors.lime, fontSize: 9, fontWeight: "800", letterSpacing: 0.3 },
  tripCard: {
    backgroundColor: colors.surface, borderRadius: radii.lg,
    borderColor: colors.border, borderWidth: StyleSheet.hairlineWidth,
    padding: spacing.sm,
  },
  tripHead: { flexDirection: "row", alignItems: "center", marginBottom: spacing.sm },
  routeChip: {
    paddingHorizontal: 8, paddingVertical: 3, borderRadius: radii.pill,
    backgroundColor: colors.limeGlow, borderColor: colors.lime, borderWidth: 1,
  },
  routeChipText: { color: colors.lime, fontWeight: "800", fontSize: 10 },
  tripDate: { color: colors.text, fontSize: 11, fontWeight: "700" },
  tripCarrier: { color: colors.text, fontSize: 13, fontWeight: "700", marginTop: 3 },
  airlineName: { color: colors.textDim, fontSize: 10, marginTop: 1 },
  flightNo: {
  ...
  editRatesBtn: {
    flexDirection: "row", alignItems: "center", gap: 4,
    paddingHorizontal: 8, paddingVertical: 5, borderRadius: radii.pill,
    backgroundColor: colors.chipBg,
    borderColor: colors.lime, borderWidth: StyleSheet.hairlineWidth,
  },
  editRatesText: { color: colors.lime, fontSize: 11, fontWeight: "700" },
  tickerWrap: { paddingHorizontal: spacing.lg, marginBottom: spacing.sm },
  ...
  slotsBar: { flexDirection: "row", alignItems: "center", gap: 6 },
  slotsTrack: { flex: 1, height: 6, backgroundColor: colors.chipBg, borderRadius: 3, overflow: "hidden" },
  slotsFill: { height: "100%", backgroundColor: colors.lime, borderRadius: 3 },
  slotsText: { color: colors.textMuted, fontSize: 10, fontWeight: "700" },
  tripNotes: { color: colors.textDim, fontSize: 11, marginTop: 6 },
  tripStrip: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 5,
